...
public class PaginaInicioUI extends PageObject {
    ...
    public static final Target BTN_ITEMS_CARRITO = Target.the("Boton de items del carrito de compras").located(By.xpath("//button[@data-toggle='dropdown' and @type='button']"));
